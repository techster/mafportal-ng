<nav class="navbar navbar-default navbar-filters">
    <div class="container-fluid">
        ...
        <div class="navbar-header">
            <button type="button" class="navbar-toggle collapsed none_out_click" data-toggle="collapse"
            ...
            <a class="navbar-brand none_out" href="#">Filters</a>
        </div>
...
@push('crud_list_scripts')
    ...
    <script>
        ...
        jQuery(document).ready(function ($) {
            $(".none_out").click(function () {
                $('.none_out_click').click();
            });

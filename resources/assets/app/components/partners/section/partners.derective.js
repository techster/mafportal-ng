app.directive('carousel2', Carousel2)
    .directive('carouselSlide2', CarouselSlide2);
...
function Carousel2() {
    return {
        ...
        '<div class="carousel-slides-container partnersList">' +
        '<carousel-slide2 ng-repeat="slide in slides" slide="slide" duplicate="before"></carousel-slide2>' +
        '<carousel-slide2 ng-repeat="slide in slides" slide="slide" duplicate="before"></carousel-slide2>' +
        '<carousel-slide2 ng-repeat="slide in slides" slide="slide" duplicate="before"></carousel-slide2>' +
        '<carousel-slide2 ng-repeat="slide in slides" slide="slide" duplicate="before"></carousel-slide2>' +
        '<carousel-slide2 ng-repeat="slide in slides" slide="slide"></carousel-slide2>' +
        '<carousel-slide2 ng-repeat="slide in slides" slide="slide" duplicate="after"></carousel-slide2>' +
        '<carousel-slide2 ng-repeat="slide in slides" slide="slide" duplicate="after"></carousel-slide2>' +
        '<carousel-slide2 ng-repeat="slide in slides" slide="slide" duplicate="after"></carousel-slide2>' +
        '<carousel-slide2 ng-repeat="slide in slides" slide="slide" duplicate="after"></carousel-slide2>' +
        '</div>' +
...
function CarouselSlide2() {
    return {
        ...
        template:'' +
            '<li>' +
                '<a href="{{slide.url}}">' +
                    '<img class="elem" ng-src="{{slide.images}}" title="{{slide.title}}">' +
                '</a>' +
            '</li>',
        link: function(scope) {
